...
export function BrandLockup({
  ...
  return (
    ...
    >
      {/* 1.08cap ≈ optical match to PP Writer caps; mark reads a hair taller */}
      <LogoMark className="h-[1.08cap] w-auto translate-y-[0.02em]" />
      {showWordmark ? (
        <span className="font-logo ml-[0.18em] leading-none tracking-[-0.04em]">
          {site.appName}
        </span>
      ) : null}
    </span>
